...
namespace WeWereBound.Engine {
    public static class MInput {
        ...
        internal static void Update() {
            if (GameEngine.Instance.IsActive && Active) {
        ...
        public class MouseData {
            ...
            public Vector2 Position {
                get {
                    return Vector2.Transform(new Vector2(CurrentState.X, CurrentState.Y), Matrix.Invert(GameEngine.ScreenMatrix));
                }

                set {
                    var vector = Vector2.Transform(value, GameEngine.ScreenMatrix);
        ...
        public class GamePadData {
            ...
            public void Update() {
                ...
                if (rumbleTime > 0) {
                    rumbleTime -= GameEngine.DeltaTime;
                    if (rumbleTime <= 0)
