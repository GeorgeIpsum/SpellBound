...
namespace WeWereBound
{
    ...
    public static class Collide
    {
        ...
        {
            PointSectors fromSector = WeWereBound.Collide.GetSector(rX, rY, rW, rH, lineFrom);
            PointSectors toSector = WeWereBound.Collide.GetSector(rX, rY, rW, rH, lineTo);
            ...
            else
            {
                ...
                if ((both & PointSectors.Top) != 0)
                {
                    edgeFrom = new Vector2(rX, rY);
                    edgeTo = new Vector2(rX + rW, rY);
                    if (WeWereBound.Collide.LineCheck(edgeFrom, edgeTo, lineFrom, lineTo))
                        return true;
                }
