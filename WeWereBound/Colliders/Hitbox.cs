...
namespace WeWereBound
{
    public class Hitbox : Collider
    {
        ...
        {
            return WeWereBound.Collide.RectToPoint(AbsoluteLeft, AbsoluteTop, Width, Height, point);
        }
        ...
        {
            return WeWereBound.Collide.RectToLine(AbsoluteLeft, AbsoluteTop, Width, Height, from, to);
        }
