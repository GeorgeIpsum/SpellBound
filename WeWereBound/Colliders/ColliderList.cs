    ...
    public class ColliderList : Collider
    {
        ...
        public ColliderList(params Collider[] colliders)
        {
            ...
            foreach (var c in colliders)
                if (c == null) throw new Exception("Cannot add a null Collider to a ColliderList.");
#endif
        ...
        public void Add(params Collider[] toAdd)
        {
            ...
            {
                if (colliders.Contains(c)) throw new Exception("Adding a Collider to a ColliderList that already contains it!");
                else if (c == null) throw new Exception("Cannot add a null Collider to a ColliderList.");
            }
#endif
        ...
        public void Remove(params Collider[] toRemove)
        {
            ...
            foreach (var c in toRemove)
            {
                ...
                else if (c == null) throw new Exception("Cannot remove a null Collider from a ColliderList.");
            }
#endif
        ...
        {
            base.Removed();
            foreach (var c in colliders) c.Removed();
        }
        ...
        public override float Left
        {
            get
            {
                ...
                for (int i = 1; i < colliders.Length; i++)
                    if (colliders[i].Left < left) left = colliders[i].Left;
            ...
            set
            {
                ...
                foreach (var c in colliders) Position.X += changeX;
            }
        }
        ...
        public override float Right
        {
            get
            {
                ...
                for (int i = 1; i < colliders.Length; i++)
                    if (colliders[i].Right > right) right = colliders[i].Right;
        ...
        public override float Top
        {
            get
            {
                ...
                for (int i = 1; i < colliders.Length; i++)
                    if (colliders[i].Top < top) top = colliders[i].Top;
            ...
            set
            {
                ...
                foreach (var c in colliders) Position.Y += changeY;
            }
        }
        ...
        public override float Bottom
        {
            get
            {
                ...
                for (int i = 1; i < colliders.Length; i++)
                    if (colliders[i].Bottom > bottom) bottom = colliders[i].Bottom;
        ...
        public override Collider Clone()
        {
            ...
            for (int i = 0; i < colliders.Length; i++) clones[i] = colliders[i].Clone();
        ...
        {
            foreach (var c in colliders) c.Render(camera, color);
        }
