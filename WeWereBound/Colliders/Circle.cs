...
namespace WeWereBound
{
    public class Circle : Collider
    {
        ...
        {
            return WeWereBound.Collide.CircleToPoint(AbsolutePosition, Radius, point);
        }

        public override bool Collide(Rectangle rect)
        {
            return WeWereBound.Collide.RectToCircle(rect, AbsolutePosition, Radius);
        }

        public override bool Collide(Vector2 from, Vector2 to)
        {
            return WeWereBound.Collide.CircleToLine(AbsolutePosition, Radius, from, to);
        }
